      ...
      <DialogContent className="sm:max-w-md font-bricolage border-zinc-700 bg-zinc-900 text-white">
        <DialogHeader>
          ...
          <DialogDescription className="text-sm text-gray-400">
            Don&apos;t hesitate to reach out if you have something interesting
        ...
        <div className="flex gap-2">
          <a
            href="https://wa.me/2347036886069"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <div className="flex flex-col gap-2">
          <a
            href="mailto:sultanabaniks@gmail.com"
            target="_blank"
            rel="noreferrer"
            className=""
          >
            <Button
              variant="outline"
              className="w-full justify-between bg-zinc-800/5 border-zinc-700"
            >
              Email <ExternalLink className="h-4 w-4" />
            </Button>
          </a>
          <a
            href="https://instagram.com/devsultan06"
            target="_blank"
            rel="noreferrer"
          >
            <Button
