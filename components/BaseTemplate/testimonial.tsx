...
export function MarqueeDemo() {
    return (
        <div className="relative flex w-full flex-col  rounded-xl items-center justify-center overflow-hidden  py-8">
            {/* Top Marquee */}
            <Marquee pauseOnHover reverse className="[--duration:20s] gap-6">
                {firstRow.map((review) => (
